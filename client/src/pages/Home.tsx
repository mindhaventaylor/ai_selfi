            ...
            <div className="mb-16 max-w-7xl mx-auto">
              ...
              <div className="text-center mb-8">
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 leading-tight">
                      {t("supportReviews.sectionTitlePart1")}{" "}
                      <span className="text-blue-400">{t("supportReviews.sectionTitleHighlight")}</span> {t("supportReviews.sectionTitlePart2")}
                    </h2>
                    <p className="text-lg text-muted-foreground">
                      {t("supportReviews.statsText")}
                    </p>
                  </div>
              ...
              <div className="space-y-6 text-white">
                <div>
                  <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
                    {t("home.boostPersonalBrand.title")}
                  </h2>
                  <p className="text-xl md:text-2xl text-gray-200">
                    {t("home.boostPersonalBrand.subtitle")}
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-sm md:text-base text-gray-200">
                    {t("supportReviews.statsTextShort")}
                  </p>
                </div>
              </div>
