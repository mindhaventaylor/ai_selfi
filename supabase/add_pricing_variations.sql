...
-- Cálculo: oldPrice = price / 0.3 (valor original que com 70% desconto = price)
-- $5 / 0.3 = $16.67 → 1667, $7 / 0.3 = $23.33 → 2333, $15 / 0.3 = $50.00 → 5000
INSERT INTO "variant_pricing" ("packKey", "variant", "currency", "price", "oldPrice", "credits", "isActive") VALUES
  ...
  ('starter', 'page1', 'USD', 500, 1667, NULL, false),
  ('pro', 'page1', 'USD', 700, 2333, NULL, false),
  ('premium', 'page1', 'USD', 1500, 5000, NULL, false),
  ('business', 'page1', 'USD', 1500, 5000, NULL, false),
  -- Page 2 variant
  ('basic', 'page2', 'USD', 500, 1667, 40, false),      -- $5 (era $16.67 - 70% desconto)
  ('standard', 'page2', 'USD', 700, 2333, 60, false),   -- $7 (era $23.33 - 70% desconto)
  ('premium', 'page2', 'USD', 1500, 5000, 100, false); -- $15 (era $50.00 - 70% desconto)

-- Page3 variant: $12, $15, $25 (1200, 1500, 2500 cents)
-- $12 / 0.3 = $40.00 → 4000, $15 / 0.3 = $50.00 → 5000, $25 / 0.3 = $83.33 → 8333
INSERT INTO "variant_pricing" ("packKey", "variant", "currency", "price", "oldPrice", "credits", "isActive") VALUES
  -- Page 1 variant (not used but keeping for compatibility)
  ('starter', 'page1', 'USD', 1200, 4000, NULL, false),
  ('pro', 'page1', 'USD', 1500, 5000, NULL, false),
  ('premium', 'page1', 'USD', 2500, 8333, NULL, false),
  ('business', 'page1', 'USD', 2500, 8333, NULL, false),
  -- Page 3 variant
  ...
  ('premium', 'page3', 'USD', 2500, 8333, 100, false);  -- $25 (era $83.33 - 70% desconto)

-- Page4 variant: $29, $39, $59 (2900, 3900, 5900 cents)
-- $29 / 0.3 = $96.67 → 9667, $39 / 0.3 = $130.00 → 13000, $59 / 0.3 = $196.67 → 19667
INSERT INTO "variant_pricing" ("packKey", "variant", "currency", "price", "oldPrice", "credits", "isActive") VALUES
  -- Page 1 variant (not used but keeping for compatibility)
  ('starter', 'page1', 'USD', 2900, 9667, NULL, false),
  ('pro', 'page1', 'USD', 3900, 13000, NULL, false),
  ('premium', 'page1', 'USD', 5900, 19667, NULL, false),
  ('business', 'page1', 'USD', 5900, 19667, NULL, false),
  -- Page 4 variant
  ('basic', 'page4', 'USD', 2900, 9667, 40, false),      -- $29 (era $96.67 - 70% desconto)
  ('standard', 'page4', 'USD', 3900, 13000, 60, false),  -- $39 (era $130.00 - 70% desconto)
  ('premium', 'page4', 'USD', 5900, 19667, 100, false); -- $59 (era $196.67 - 70% desconto)

-- Page5 variant: $35, $45, $75 (3500, 4500, 7500 cents)
-- $35 / 0.3 = $116.67 → 11667, $45 / 0.3 = $150.00 → 15000, $75 / 0.3 = $250.00 → 25000
INSERT INTO "variant_pricing" ("packKey", "variant", "currency", "price", "oldPrice", "credits", "isActive") VALUES
  -- Page 1 variant (not used but keeping for compatibility)
  ('starter', 'page1', 'USD', 3500, 11667, NULL, false),
  ('pro', 'page1', 'USD', 4500, 15000, NULL, false),
  ('premium', 'page1', 'USD', 7500, 25000, NULL, false),
  ('business', 'page1', 'USD', 7500, 25000, NULL, false),
  -- Page 5 variant
  ('basic', 'page5', 'USD', 3500, 11667, 40, false),     -- $35 (era $116.67 - 70% desconto)
